...
<a href="{{ url('home') }}">Accueil</a>
    ...
    <div>
        <div class="float-end">
            <form class="d-flex" action="{{ '/revenue' }}"  method="GET">
        ...
        <p style="text-align: center; font-family: new time roman;">RECIPE REGISTRATION</p>
        <hr>
    </div>
        ...
        <div class="col-mt-10">
                <div class="container-fluid h-custom">
                      ...
                      <form action="{{url('/revenue')}}" method="POST" enctype="multipart/form-data">
                        ...
                        {{-- <div class="text-center text-lg-start mt-4 pt-2">
                            <button type="submit" class="btn btn-outline-warning" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="save_revenue">list of recipe...<<<</button>
                          <br>
    ...
    <br>
    <br>
    <div id="test_revenue" class="container active_container">
        <div class="col-mt-8">
            <table class="table table-hover" style="border: 1px">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('/revenueUpdate', $revenue->id) }}" class="btn btn-sm btn-primary rounded-0"><i class="fas fa-edit"></i></a>
                        </td>
                    </tr>
                    @empty
                    <p class="text-center">
            ...
            <div style="margin-left: 45%">
                {{ $revenues->appends(['search' => request()->query('search')])->links() }}
            </div>
        </div>
    </div>
    ...
    {{-- <script>
        const test_revenue = document.querySelector('#test_revenue');
        const buttonToggle = document.querySelector('.btn-outline-warning');
        buttonToggle.addEventListener("click", (e)=>{
            test_revenue.classList.toggle("active_container");
            // alert("Salut");
        })
    </script> --}}
