    ...
    <div class="container" id="id01">
        <div class="col-mt-10">
                <div class="container-fluid h-custom">
                        <br>
                        <br>
                      <form action="{{url('/editrevenue', $data->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="text-center text-lg-start mt-4 pt-2">
                            <a href="{{url('/deleterevenue', $data->id)}}" class="btn btn-lg btn-danger" onclick="return(confirm('Are you sure to delete this?'))" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="delete">Delete</a>
                          <br>
